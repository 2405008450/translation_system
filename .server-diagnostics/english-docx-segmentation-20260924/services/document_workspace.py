...
from app.services.docx_segmentation import segmentation_scope, prepare_package, annotate_segments, validate_profile
...
DOCUMENT_PARSE_STRING_OPTION_FIELDS.add("segmentation_profile")
...
def normalize_document_parse_options(
    ...
    for key in DOCUMENT_PARSE_STRING_OPTION_FIELDS:
        ...
        elif key == "segmentation_profile":
            options[key] = validate_profile(raw_options[key])
...
def _render_table_cell(
    ...
    def flush_paragraphs() -> None:
        ...
        for grouped_paragraph in _group_cell_paragraphs(paragraph_buffer):
            ...
            annotate_segments(grouped_paragraph.paragraph, paragraph_segments)
...
def _render_paragraph(
    ...
    annotate_segments(paragraph, paragraph_segments)
