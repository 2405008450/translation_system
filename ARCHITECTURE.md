...
| TM 管理 | `/api/translation-memory/collections*`、entries、batch、merge、append、import、preview-sdltm、同步/异步 export；`append` 将一个或多个来源库追加到同语言对的现有目标库，支持保留目标译文或来源覆盖 |
