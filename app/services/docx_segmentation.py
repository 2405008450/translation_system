...
def _unsafe(p):
    forbidden = {'drawing', 'pict', 'object', 'fldChar', 'fldSimple', 'instrText', 'ins', 'del', 'moveFrom', 'moveTo', 'sectPr', 'pageBreakBefore', 'outlineLvl', 'tab', 'hyperlink', 'footnoteReference', 'endnoteReference', 'vanish', 'webHidden', 'sym', 'noBreakHyphen', 'commentRangeStart', 'commentRangeEnd', 'bookmarkStart', 'bookmarkEnd'}
    for n in p.iter():
