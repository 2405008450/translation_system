...
from app.auth import can_access_all_projects, get_user_display_name, serialize_user
...
def _require_marker_write_access(marker: IssueMarker, current_user: User) -> None:
    if can_access_all_projects(current_user) or marker.reporter_id == current_user.id:
        return
