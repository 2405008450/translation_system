...
class DocxAdapter(FormatAdapter):
    ...
    def _parse_paragraph(self, paragraph: Paragraph) -> Optional[BlockNode]:
        """解析段落
        ...
        Returns:
            Optional[BlockNode]: 段落节点，如果段落为空则返回 None
        """
    ...
    def _iter_block_items(self, parent: Union[DocxDocument, _Cell]) -> Iterator[Union[Paragraph, Table]]:
        """迭代文档中的块级元素
