...
class TermbaseCollection(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_term_bases_langs", "source_language", "target_language"),
    )
...
class SegmentHistory(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_segment_history_sentence_id", "sentence_id"),
        Index("ix_segment_history_created_at", "created_at"),
    )
    ...
    confirm_type: Mapped[str | None] = mapped_column(String(30), nullable=True)
